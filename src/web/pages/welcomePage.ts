  ...
  <script>
    const I18N = {
      EN: {
        ...
        oauthNoAccounts: 'Meta login succeeded, but no ad account was granted. Make sure you tick the ad account in the Facebook dialog, or assign it to your user in Meta Business Settings → Ad Accounts, then reconnect.',
      ...
      AR: {
        ...
        oauthNoAccounts: 'نجح تسجيل الدخول لكن لم يُمنح أي حساب إعلاني. تأكد من تحديد الحساب الإعلاني داخل نافذة فيسبوك أثناء الربط، أو عيّنه لمستخدمك في إعدادات Meta Business ← الحسابات الإعلانية، ثم أعد الربط.',
