    ...
    for (const day of days) {
      ...
      await prisma.dailyStat.upsert({
        ...
        create: {
          ...
          entityId:   campaignRow.id,
          date:       day,
          spend: spendMinor, impressions, reach: impressions / 2n, clicks,
          linkClicks: clicks * 35n / 100n, landingPageViews: clicks * 30n / 100n, uniqueClicks: clicks * 9n / 10n,
  ...
  for (const day of days) {
    ...
    await prisma.dailyStat.upsert({
      ...
      create: {
        ...
        linkClicks: a.clk * 35n / 100n, landingPageViews: a.clk * 30n / 100n, uniqueClicks: a.clk * 9n / 10n, messages: a.msg, purchases: 0n, leads: 0n,
