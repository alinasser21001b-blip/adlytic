// ════════════════════════════════════════════════════════════════════════
//  src/services/metaCapabilityReport.ts
//
//  Turns probe results into the two documents. Extracted so the CLI runner
//  and the admin route emit BYTE-IDENTICAL output — a probe run whose report
...
export function matrixMd(results: ProbeResult[], ctx: ProbeRunContext): string {
...
export function reportMd(results: ProbeResult[], ctx: ProbeRunContext): string {
...
If AVAILABLE with the field present, each stored conversion count can carry the window
