...
'/api/admin/ops':{computedAt:now(),overall:'ERROR',
 build:{commit:'63731b92d89e7e9adc821547206c48f842ff8896',shortCommit:'63731b9',branch:'claude/adlytic-31edjv',message:'feat(probe): freeze Round 1 evidence, add fallback entity discovery',deploymentId:'dep_7f2a',source:'RAILWAY_GIT_COMMIT_SHA',bootedAt:new Date(Date.now()-5400e3).toISOString(),resolved:true},known:['database','redis','meta'],unknown:['queue','workers','intelligence'],
