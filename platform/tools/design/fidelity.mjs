...
export const SCREENS = {
  ...
  R8: {
    ...
    verdicts: {
      ...
      Motion: ["exact", "The delivered `offerArrival` stagger is implemented: rows enter one after another, from the token, at the delivered duration. Reduced motion removes it. A screen cannot write a duration — the layer check rejects one, proved."],
      Icon: ["blocked", "No icon set."],
